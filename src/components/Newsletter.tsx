      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 leading-relaxed mb-10">
            Subscribe to receive exclusive style tips, early access to new content,
          ...
          {subscribed ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
              <input
                ...
                className="flex-1 px-6 py-4 border border-gray-300 text-sm focus:outline-none focus:border-amber-700 transition-colors duration-300"
                required
              />
              <button
                type="submit"
                className="px-8 py-4 bg-gray-900 text-white text-sm tracking-widest uppercase hover:bg-amber-700 transition-colors duration-300 whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
          ...
          <div className="mt-16 pt-12 border-t border-gray-200">
            <p className="text-sm text-gray-500 mb-6 tracking-wider uppercase">
              Follow Me
            </p>
            <div className="flex justify-center gap-6">
              <a
                href="#"
                className="w-12 h-12 flex items-center justify-center border border-gray-300 rounded-full text-gray-600 hover:border-amber-700 hover:text-amber-700 transition-all duration-300"
